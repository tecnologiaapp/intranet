...
@section('title', 'Agregar emprendimiento')
@section('content')

<div class="card card-preview">
	<div class="card-inner mt-3">
		<form action="{{ route('panel.entrepreneurship.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
			<div class="row">
				<div class="mb-3 col-sm-12 col-lg-12 col-xl-6">
					<label for="title" class="form-label">Título del emprendimiento</label>
					<input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title" value="{{ old('title') }}" placeholder="Título del emprendimiento">
					@error('title')
