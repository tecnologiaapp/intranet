      ...
      <div class="nk-block-head nk-block-head-sm">
         <div class="nk-block-between">
            <div class="nk-block-head-content">
               <div class="nk-block-des text-soft"><p>{{ $users->count() }} en total.</p></div>
            </div>
            <div class="nk-block-head-content">
      ...
      <div class="nk-block">
         <div class="nk-tb-list is-separate mb-3">
            <div class="nk-tb-item nk-tb-head">
               ...
               <div class="nk-tb-col tb-col-md"><span class="sub-text">Sub/dirección</span></div>
               <div class="nk-tb-col tb-col-lg"><span class="sub-text">Número</span></div>
               <div class="nk-tb-col tb-col-lg"><span class="sub-text">Estado</span></div>
               <div class="nk-tb-col tb-col-md"><span class="sub-text">Lugar de nacimiento</span></div>
               <div class="nk-tb-col tb-col-md"><span class="sub-text">Editar</span></div>
            ...
            <div class="nk-tb-item">
               ...
               <div class="nk-tb-col tb-col-mb">
                  <span class="tb-amount">{{ $user->dependency->title }}</span>
               </div>
               <div class="nk-tb-col tb-col-md"><span>{{ $user->phone_number }}</span></div>
               <div class="nk-tb-col tb-col-md"><span class="tb-status user-status-{{ $user->status }}">{{__($user->status) }}</span></div>
               <div class="nk-tb-col tb-col-lg"><span>{{ $user->city->name }} ({{ $user->city->state }})</span></div>
               ...
               <div class="nk-tb-col nk-tb-col-tools">
                  <ul class="nk-tb-actions gx-1">
                     <li class="nk-tb-action-hidden">
                        <a href="#" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="" data-original-title="Enviar mensaje"><em class="icon lni lni-envelope"></em></a>
                     </li>
                     <li>
                        <div class="drodown">
                           ...
                           <div class="dropdown-menu dropdown-menu-right">
                              <ul class="link-list-opt no-bdr">
                              	<li>
                                    <a href="{{ route('panel.user.edit', $user) }}"><em class="icon lni lni-pencil-alt"></em><span>Editar</span></a>
                                 </li>
                                 <li>
                                    <a href="{{ route('user.team.show', [$user->dependency, $user]) }}" target="_blank"><em class="icon lni lni-eye"></em><span>Ver perfil</span></a>
                                 </li>
                                 {{-- <li>
