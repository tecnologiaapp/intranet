...
<div class="card card-preview">
	<div class="card-inner mt-3">
		<form action="{{ route('panel.notices.update', $notice) }}" method="POST" enctype="multipart/form-data">
			@csrf
			<div class="row">
				<div class="mb-3 col-sm-12 col-lg-6 col-xl-6">
					<label for="title" class="form-label">Título de la noticia</label>
					<input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title" value="{{ $notice->title }}" placeholder="Título de la noticia">
					@error('title')
				...
				<div class="mb-3 col-sm-12 col-lg-6 col-xl-3">
					...
					<input type="date" name="date" class="form-control @error('date') is-invalid @enderror" id="date" value="{{ $notice->created_at->format('Y-m-d') }}" placeholder="Título de la noticia">
					@error('date')
						<p class="text-danger">{{ $message }}</p>
					@enderror
				</div>
            ...
            <div class="col-sm-12">
               <div class="form-group">
                  ...
                  <textarea class="form-control" id="body" name="body">{!! $notice->content !!}</textarea>
