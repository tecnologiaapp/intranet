      ...
      <div class="nk-block-head nk-block-head-sm">
         <div class="nk-block-between">
            <div class="nk-block-head-content">
               <div class="nk-block-des text-soft"><p>{{ $learns->count() }} en total.</p></div>
            </div>
            <div class="nk-block-head-content">
                  ...
                  <div class="toggle-expand-content" data-content="more-options">
                     <ul class="nk-block-tools g-3">
                        ...
                        <li class="nk-block-tools-opt">
                           <a href="#" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a><a href="{{ route('panel.learn.create') }}" class="btn btn-primary d-none d-md-inline-flex"><em class="icon lni lni-plus"></em><span>Agregar</span></a>
                        </li>
                     </ul>
                  </div>
               </div>
         ...
         <div class="nk-tb-list is-separate mb-3">
            ...
            <div class="nk-tb-item">
               ...
               <div class="nk-tb-col tb-col-mb">
                  <span class="tb-amount">{{ __($learn->status) }}</span>
               </div>

               <div class="nk-tb-col tb-col-mb">
                  <span class="tb-amount">{{ $learn->created_at->diffForHumans() }}</span>
               </div>
                     ...
                     <li>
                        <div class="drodown">
                           ...
                           <div class="dropdown-menu dropdown-menu-right">
                              <ul class="link-list-opt no-bdr">
                                 <li>
                                    <a href="{{ route('user.learn.show', $learn) }}" target="_blank"><em class="icon lni lni-eye"></em><span>Ver</span></a>
                                 </li>
                              	<li>
                                    <a href="{{ route('panel.learn.edit', $learn) }}"><em class="icon lni lni-pencil-alt"></em><span>Editar</span></a>
                                 </li>
                                 {{-- <li>
