...
@section('title', 'Agregar palabras del director')
@section('content')

<div class="card card-preview">
	<div class="card-inner mt-3">
		<form action="{{ route('panel.words.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
			<div class="row">
				<div class="mb-3 col-sm-12 col-lg-12 col-xl-6">
					<label for="title" class="form-label">Título de las palabras del director</label>
					<input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title" value="{{ old('title') }}" placeholder="Título de las palabras del director">
					@error('title')
