...
<div id="header">
    ...
    <script id="infogram_0_3911b097-0995-4130-8c93-88815dd1046a" title="Copy: Paisaje y patrimonio (326)" src="https://e.infogram.com/js/dist/embed.js?LYr" type="text/javascript"></script>
...
<tbody>
  <tr>
    <td>333111</td>
    <td>Apoyar técnicamente la estructuración de intervenciones en fachadas</td>
    <td>Recuperación integral del patrimonio y paisaje urbano</td>
   
  </tr>
  <tr>
    <td>333212</td>
    <td>Gestionar las intervenciones fisicas en espacio público</td>
    <td>Recuperación integral del patrimonio y paisaje urbano</td>
    
  </tr>
  <tr>
    <td>333412</td>
    <td>Apoyar tecnicamente el operador urbano</td>
    <td>Recuperación integral del patrimonio y paisaje urbano</td>
  </tr>
...
const etiquetas = ["Paisaje Prado"]
// Podemos tener varios conjuntos de datos
const datosVentas2020 = {
    label: "Presupuesto General",
    data: [2837465945], // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
...
const datosVentas2021 = {
    label: "Ejecutado",
    data: [385833797], // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
...
new Chart($barras, {
    type: 'bar',// Tipo de gráfica
    data: {
        labels: ['333111','Ejecutado', '333212', 'Ejecutado','333412','Ejecutado'],
        datasets: [{
            label: 'Presupuesto',
            data: [80234543, 13892574, 2376663429, 0, 380567973, 371941223],
            fill: false,
            backgroundColor: [
              'rgba(217, 143, 6, 0.8)',
              'rgba(217, 143, 6, 0.2)',
