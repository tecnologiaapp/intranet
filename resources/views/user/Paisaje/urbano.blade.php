...
<div id="header">
    ...
    <script id="infogram_0_87f5ee38-3717-43c2-949e-72063278a457" title="Paisaje Urbano (334)" src="https://e.infogram.com/js/dist/embed.js?3Cw" type="text/javascript"></script>
...
<tbody>
  <tr>
    <td scope="row">334111</td>
    <td>Diseñar las intervenciones</td>
    <td>Recuperación e intervención integral del paisaje urbano -APP</td>
   
  </tr>
  <tr>
    <td scope="row">334112</td>
    <td>Gestionar la intervención del espacio público y el paisaje urbano integral</td>
    <td>Recuperación e intervención integral del paisaje urbano -APP</td>
    
  </tr>
  <tr>
    <td scope="row">334211</td>
    <td> Elaborar documentos técnicos y apoyar a las gestiones</td>
    <td>Recuperación e intervención integral del paisaje urbano -APP</td>
  </tr>
  <tr>
    <td scope="row">334212</td>
    <td> Elaborar documentos técnicos y realizar socialización de las intervenciones</td>
    <td>Recuperación e intervención integral del paisaje urbano -APP</td>
  </tr>
  <tr>
    <td scope="row">334311</td>
    <td>Apoyar técnicamente las intervenciones de iluminación arquitectónica</td>
    <td>Recuperación e intervención integral del paisaje urbano -APP</td>
  </tr>
...
const datosVentas2020 = {
    ...
    data: [7004131532], // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
...
const datosVentas2021 = {   
    ...
    label: "Ejecutado",
    data: [4717831869], // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
...
// Las etiquetas son las que van en el eje X. 
const etiqueta = ["334211"]
// Podemos tener varios conjuntos de datos
const general = {
    label: "Presupuesto General",
    data: [1130567973], // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
    backgroundColor: 'rgba(54, 162, 235, 0.2)', // Color de fondo
    borderColor: 'rgba(54, 162, 235, 1)', // Color del borde
    borderWidth: 1,// Ancho del borde
};
const ejecutado = {   
    ...
    label: "Ejecutado",
    data: [277874467], // La data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
    backgroundColor: 'rgba(255, 159, 64, 0.2)',// Color de fondo
    borderColor: 'rgba(255, 159, 64, 1)',// Color del borde
    borderWidth: 1,// Ancho del borde
};
...
new Chart($barras, {
    type: 'bar',// Tipo de gráfica
    data: {
        labels: ['334111','Ejecutado', '334112', 'Ejecutado','334212','Ejecutado', '334311','Ejecutado'],
        datasets: [{
            label: 'Presupuesto',
            data: [1529694400, 1490924712, 4093869160, 2822032690, 186680771, 127000000, 63319228, 0],
            fill: false,
            backgroundColor: [
              'rgba(217, 143, 6, 0.8)',
              'rgba(217, 143, 6, 0.2)',
