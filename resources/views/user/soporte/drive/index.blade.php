...
<section  class="why-us">
    ...
    <div class="row" style="justify-content: space-between;">
        ...
        <div class="d-md-flex justify-content-md-end">
            ...
            <form action="{{ route('user.soporte.drive.index') }}" method="GET">
                <div class="btn-group">
...
<div class="card-body px-0 pt-0 pb-2">
              ...
              <div class="table-responsive p-0" style="width:100%; height:100%; overflow:auto; vertical-align: middle;">
                <table class="table align-items-center mb-0 table-bordered">
                  ...
                  <tbody>
                    @foreach($drive as $driv)
                    <tr>
                    <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->id}}</p>                          
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->cedula_usuario}}</p>                          
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->nombres_usuario}}</p>                          
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->apellidos_usuario}}</p>                          
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->correo_usuario}}</p>                          
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->subdirección_usuario}}</p>                          
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->unidad}}</p>                          
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->permiso_unidad}}</p>                          
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->observacion}}</p>                          
                          </div>
                        </div>
                      </td> 
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <p class="text-xs font-weight-bold mb-0">{{$driv->estado}}</p>                          
                          </div>
                        </div>
                      </td>                 
                      <td class="btn-group">
                          <a href="{{ route('user.soporte.drive.edit', $driv->id) }}" class="btn-get-blue">Editar</a>
                          <form action="{{ route('user.soporte.drive.destroy', $driv->id) }}" method="POST">
                              @method('DELETE')
                              @csrf
                  ...
                  <tfoot>
                      <tr class="table-footer">
                          <td colspan="1"> {{$drive->appends(['texto'=>$texto])}} </td>
                      </tr>
                  </tfoot>
                </table>
              </div>
