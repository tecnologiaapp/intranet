            ...
            <div class="card">
                ...
                <div class="card-body">
                      <div class="col-md-12 pt-2">
                        <a href="{{ route('user.soporte.configuracion.user') }}">
                           <button type="submit" class="btn-get-principal">Consultar</button>
                        </a>                     
                      </div>
                    <form class="row g-3" action="{{ route('user.soporte.configuracion.store') }}" method="POST" enctype="multipart/form-data" style="justify-content: space-between;">
                      @csrf
                      ...
                      <div class="col-md-12 pt-2" align="center">
                        <button class="btn-get-principal">Registrar solicitud</button>
                      </div>
