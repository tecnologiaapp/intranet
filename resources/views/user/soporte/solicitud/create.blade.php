            ...
            <div class="card">
                ...
                <div class="card-body">
                      <div class="col-md-12 pt-2">
                        <a href="{{ route('user.soporte.solicitud.user') }}">
                    ...
                    <form class="row g-3" action="{{ route('user.soporte.solicitud.store') }}" method="POST" enctype="multipart/form-data" style="justify-content: space-between;">
                      ...
                      <div class="col-md-6 pb-3">
                            ...
                            <input type="text" class="form-control" name="nombre_solicitante" placeholder="Ingrese nombres" required>
                      </div>
                      <div class="col-md-6">
                            <label class="form-label">Apellidos</label>
                            <input type="text" class="form-control" name="apellido_solicitante" placeholder="Ingrese apellidos" required>
                      </div>
                      <div class="col-md-6">
                            <label class="form-label">Correo electronico</label>
                            <input type="text" class="form-control" name="correo_solicitante" placeholder="Ingrese correo electrónico" required>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6 pb-2">
                            ...
                            <input type="number" class="form-control" name="telefono_usuario" placeholder="Ingrese telefono" required>
                      </div>
                      <div class="col-md-6">
                            <label class="form-label">Correo electronico</label>
                      ...
                      <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" name="numero_contrato" placeholder="Ingrese numero de contrato" required>
                      </div>
                      <div class="col-md-6 pb-2">
                      ...
                      <div class="col-md-6 pb-2">
                            ...
                            <input type="text" placeholder="Opcional" class="form-control" name="unidad">
                      </div>
                      <div class="col-md-6">
                      <label class="form-label">Tipo de permiso de la unidad compartida:</label>
                      ...
                      <div class="col-md-6">
                            ...
                            <textarea class="form-control" required cols="30" rows="8" name="objeto_contrato" placeholder="Ingrese el objeto del contrato"></textarea>
                      </div>
